...
void generateMap()
{
   ...
   // rand_x = uniform_real_distribution<double>(-size_x / 2.0, size_x / 2.0);
    ...
    rand_y = uniform_real_distribution<double>(-size_y / 2.0, 7.5);//hanhan
...
{        
    ...
    //         std::ifstream fin(std::string("/home/han/2022Codes/MPNet/S2D/dataset/obs_cloud/obc")+std::to_string(i)+ std::string(".dat"), std::ios::binary);
    ...
    //                 }
    //             }
    //             cv::imwrite(std::string("/home/han/2022Codes/MPNet/S2D/dataset/obs_map/obc")+std::to_string(i)+string(".png"), image);
    //         }
    //         //save esdf image
    //         // {   
    //         //     double max_dis = 10.0;
    ...
    //         //         }
    //         //     }
    //         //     cv::imwrite(std::string("/home/han/2022Codes/MPNet/S2D/dataset/obs_esdf/obc")+std::to_string(i)+string(".png"), esdfImage);
   ...
   */
    ...
    // for(int k = map_idx; k < map_idx+9999; k++){
        std::string prefix = "/home/han/learning_code/testdata3/e"+std::to_string(k);
        std::ifstream fpath(prefix+std::string("/path1.dat"));
        if (fpath.good()){
            continue;
        }
        ...
        uniform_int_distribution<unsigned> u3(0,1);
        obs_num[0] = u1(eng);
        obs_num[1] = u2(eng);
        obs_num[2] = u3(eng);
        generateMap();
        ...
        std::ofstream fout(std::string("/home/han/learning_code/testdata3/obcs/obc")+std::to_string(k)+std::string(".dat"), std::ios::binary);
        ...
        {   
            ...
            cv::FileStorage fs(std::string("/home/han/learning_code/testdata3/esdfmaps/")+std::to_string(k)+string(".xml"), cv::FileStorage::WRITE);
